...
public class HttpUtils {
    ...
    static {
        try {
            ...
            System.out.println("SSLContext init with NoSuchAlgorithmException");
        } catch (KeyManagementException e) {
            System.out.println("SSLContext init with KeyManagementException");
        }
    ...
    public static String getResponseContentString(HttpGet httpget, CloseableHttpClient httpClient) {
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                ...
                System.out.println("http get:{} response status code is not 200!" +  response.getStatusLine().getStatusCode());
            }
